...
public interface FuelangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link FuelangParser#termoResto}.
	 * @param ctx the parse tree
	 */
	void enterTermoResto(FuelangParser.TermoRestoContext ctx);
	/**
	 * Exit a parse tree produced by {@link FuelangParser#termoResto}.
	 * @param ctx the parse tree
	 */
	void exitTermoResto(FuelangParser.TermoRestoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FuelangParser#fatorResto}.
	 * @param ctx the parse tree
	 */
	void enterFatorResto(FuelangParser.FatorRestoContext ctx);
	/**
	 * Exit a parse tree produced by {@link FuelangParser#fatorResto}.
	 * @param ctx the parse tree
	 */
	void exitFatorResto(FuelangParser.FatorRestoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FuelangParser#termoLogicoResto}.
	 * @param ctx the parse tree
	 */
	void enterTermoLogicoResto(FuelangParser.TermoLogicoRestoContext ctx);
	/**
	 * Exit a parse tree produced by {@link FuelangParser#termoLogicoResto}.
	 * @param ctx the parse tree
	 */
	void exitTermoLogicoResto(FuelangParser.TermoLogicoRestoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FuelangParser#fatorLogicoResto}.
	 * @param ctx the parse tree
	 */
	void enterFatorLogicoResto(FuelangParser.FatorLogicoRestoContext ctx);
	/**
	 * Exit a parse tree produced by {@link FuelangParser#fatorLogicoResto}.
	 * @param ctx the parse tree
	 */
	void exitFatorLogicoResto(FuelangParser.FatorLogicoRestoContext ctx);
	/**
